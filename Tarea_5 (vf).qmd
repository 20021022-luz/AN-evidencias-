...
i)  Realiza la respectiva gráfica en el intervalo dado.

ii) Compara las gráficas de las derivadas aproximadas de la función `derivative` de `Scipy`, con dos tamaños de paso utilizando la función `nd.Derivative` y la derivada *exacta* en tal intervalo.

iii) Compara las gráficas de las segundas derivadas aproximadas con dos tamaños de paso utilizando la función `nd.Derivative` y la segunda derivada *exacta* en tal intervalo.

iv) Realiza las gráficas de los errores absolutos en cada caso.
...
Derivada : $f'(x)= 2e^{2x}+2sin(2x)$. Aproximaciones con dos tamaños de paso $h=0.01$ y $h=0.2$
...
df_02 = nd.Derivative(f, step=0.2, method='central', order=2)
...
fig.add_trace(go.Scatter(x= x_values, y= df_02(x_values), mode='lines', name='h=0.2', line=dict(color='royalblue', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_02(x_values)), mode='lines', name='h=0.2', line=dict(color='teal', width=1)))
...
Segunda derivada: $f''(x)=4e^{2x}+4cos(2x)$. Aproximaciones con $h=0.01$ y $h=0.2$
...
ddf_02 = nd.Derivative(f, step=0.05, method='central', order=2, n = 2)

fig = go.Figure()
fig.add_trace(go.Scatter(x= x_values, y= ddf_01(x_values), mode='lines', name='h=0.1', line=dict(color='royalblue', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= ddf_02(x_values), mode='lines', name='h=0.2', line=dict(color='teal', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(dderf(x_values)-ddf_02(x_values)), mode='lines', name='h=0.2', line=dict(color='teal', width=1)))
...
Derivada : $f'(x)= \frac{(1)}{(x+2)}-2(x+1)$. Aproximaciones con dos tamaños de paso $h=0.05$ y $h=0.1$
...
# Función de numdifftools
df_0 = nd.Derivative(f, step=0.1, method='central', order=2)
df_005 = nd.Derivative(f, step=0.05, method='central', order=2)


fig = go.Figure()
# Aproximación de la derivada con los tamaños de paso 
fig.add_trace(go.Scatter(x= x_values, y= df_0(x_values), mode='lines', name='h=0.1', line=dict(color='teal', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_0(x_values)), mode='lines', name='h=0.1', line=dict(color='royalblue', width=1)))
...
Segunda derivada: $f''(x)= - \frac{1}{(x+2)^2}-2$. Aproximaciones con $h=0.05$ y $h=0.1$
...
# Funciones de numdifftools para la segunda derivada
ddf_0 = nd.Derivative(f, step=0.1, method='central', order=2, n = 2)
ddf_005 = nd.Derivative(f, step=0.05, method='central', order=2, n = 2)

fig = go.Figure()
fig.add_trace(go.Scatter(x= x_values, y= ddf_0(x_values), mode='lines', name='h=0.1', line=dict(color='royalblue', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(dderf(x_values)-ddf_0(x_values)), mode='lines', name='h=0.1', line=dict(color='royalblue', width=1)))
...
Derivada : $f'(x)=-6cos(3x)sin(3x)-2e^{2x}$. Aproximaciones con dos tamaños de paso $h=pi/2$ y $h=0.1$
...
# Función de numdifftools
df_01 = nd.Derivative(f, step=0.1, method='central', order=2)
df_pi = nd.Derivative(f, step=np.pi/2, method='central', order=2)


fig = go.Figure()
# Aproximación de la derivada con los tamaños de paso 
fig.add_trace(go.Scatter(x= x_values, y= df_01(x_values), mode='lines', name='h=0.1', line=dict(color='teal', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= df_pi(x_values), mode='lines', name='h=pi/2', line=dict(color='royalblue', width=1)))
# Aproximación de la derivada con derivative de Scipy
fig.add_trace(go.Scatter(x= x_values, y= derivative(f, x_values).df, mode='lines', name='SciPy', line=dict(color='aqua', width=2)))
# Derivada "exacta"
fig.add_trace(go.Scatter(x= x_values, y= derf(x_values), mode='lines', name='Derivada', line=dict(color='goldenrod', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_01(x_values)), mode='lines', name='h=0.1', line=dict(color='royalblue', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_pi(x_values)), mode='lines', name='h=pi/2', line=dict(color='teal', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-derivative(f, x_values).df), mode='lines', name='SciPy', line=dict(color='aqua', width=2)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_01(x_values)), mode='lines', name='h=0.1', line=dict(color='royalblue', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_pi(x_values)), mode='lines', name='h=pi', line=dict(color='teal', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-derivative(f, x_values).df), mode='lines', name='SciPy', line=dict(color='aqua', width=2)))
...
Segunda derivada: $f''(x)= -18(cos^23x-sin^23x)-4e^{2x}$. Aproximaciones con $h= pi/2$ y $h=0.1$

```{python}
#| code-fold: true
#| warning: false

dderf = lambda x: -18 * ((np.cos(3*x))**2 - (np.sin(3*x))**2) - 4 * np.exp(2*x)

# Funciones de numdifftools para la segunda derivada
ddf_01 = nd.Derivative(f, step=0.1, method='central', order=2, n = 2)
ddf_pi = nd.Derivative(f, step=np.pi, method='central', order=2, n = 2)

fig = go.Figure()
fig.add_trace(go.Scatter(x= x_values, y= ddf_01(x_values), mode='lines', name='h=0.1', line=dict(color='royalblue', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= ddf_pi(x_values), mode='lines', name='h=pi', line=dict(color='teal', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= dderf(x_values), mode='lines', name='2da. derivada', line=dict(color='goldenrod', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(dderf(x_values)-ddf_01(x_values)), mode='lines', name='h=0.1', line=dict(color='royalblue', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= abs(dderf(x_values)-ddf_pi(x_values)), mode='lines', name='h=pi/2', line=dict(color='teal', width=1)))
...
x_values = np.linspace(0 , f.ppf(0.99, df1, df2), 500)

plt.figure(figsize=(8,6))
plt.plot(x_values, f.pdf(x_values, df1, df2), label="Función de densidad")
plt.grid()
plt.legend()
plt.show()
...
Elegimos el intervalo $[0.5,2.5]$ para calcular la integral.
...
plt.figure(figsize=(8,6))
plt.plot(x_values, f.pdf(x_values, df1, df2), label="Función de densidad")
plt.fill_between(np.linspace(a1,b1, 500), y1=0, y2=f.pdf(np.linspace(a1,b1, 500), df1, df2), color="green", alpha=0.5)
plt.grid()
plt.legend()
plt.show()
...
integral = integrate.quad(f.pdf, a1, b1, args = (df1,df2))
...
```{python}
f.cdf(2.5, df1, df2) - f.cdf(0.5, df1, df2)
```
